...
export class App extends Component {
    ...
    async componentDidMount() {
        ...
        window.ethereum.on('accountsChanged', async function(event) {
            this.setState({
    ...
    render() {
        return <React.Fragment>
            ...
            <div className="row">
                ...
                <div className="col-sm">
                    <Panel title="Loyalty points - refundable ether">
                        ...
                        <button className="btn btn-sm bg-success text-white" onClick={() => this.refundLoyaltyPoints()}>Refund</button>
                    </Panel>
                </div>
            </div>
            <div className="row">
            ...
            <ToastContainer class="toast-top-right" ref={(input) => this.container = input} />
        </React.Fragment>
    }
}